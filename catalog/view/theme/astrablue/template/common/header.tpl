...
<!-- external css/js -->
<link href="catalog/view/theme/astrablue/js/fancybox/jquery.fancybox.css" rel="stylesheet">
<script src="catalog/view/theme/astrablue/js/fancybox/jquery.fancybox.js" type="text/javascript"></script>
<!-- external css/js end-->
...
<link href="catalog/view/theme/astrablue/stylesheet/animate.css" rel="stylesheet">
<?php } ?>
<link href="catalog/view/theme/astrablue/stylesheet/stylesheet.css" rel="stylesheet">
<link href="catalog/view/theme/astrablue/stylesheet/font-awesome.css" rel="stylesheet">

<link rel="stylesheet" type="text/css" href="catalog/view/javascript/jquery/owl-carousel/owl.carousel.css">
<link href="catalog/view/theme/astrablue/stylesheet/style.css" rel="stylesheet">
...
<script src="catalog/view/theme/astrablue/js/parallax.js" type="text/javascript"></script>
<script src="catalog/view/theme/astrablue/js/common.js" type="text/javascript"></script>
<script src="catalog/view/theme/astrablue/js/common1.js" type="text/javascript"></script>
<script src="catalog/view/theme/astrablue/js/cloudzoom.js" type="text/javascript"></script>
...
<div id="mgkquickview">
<div id="magikloading" style="display:none;text-align:center;margin-top:400px;"><img src="catalog/view/theme/astrablue/image/loading.gif" alt="loading">
</div></div>