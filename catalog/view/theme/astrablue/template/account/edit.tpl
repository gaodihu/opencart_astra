      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="buttons clearfix">
          ...
          <a href="<?php echo $back; ?>">
            <button class="button back" type="button"><span><?php echo $button_back; ?></span></button>
            </a>
          <button type="submit" class="button continue pull-right"><span><?php echo $button_continue; ?></span></button>
          </div>
        </div>
      </form>
      </div>
