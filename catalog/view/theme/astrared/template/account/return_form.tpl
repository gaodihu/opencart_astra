    ...
    <div id="content" class="<?php echo $class; ?> col-main"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <div class="input-group date"><input type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" placeholder="<?php echo $entry_date_ordered; ?>" data-date-format="YYYY-MM-DD" id="input-date-ordered" class="form-control" /><span class="input-group-btn">
                <button type="button" class="btn btn-default calender"><i class="fa fa-calendar"></i></button>
                </span></div>
            </div>
          </div>
        </fieldset>
        ...
        <div class="buttons clearfix">
          <div class="left">
          <a href="<?php echo $back; ?>" class=""><button class="button btn btn-danger"><?php echo $button_back; ?></button></a>&nbsp;
          <?php echo $text_agree; ?>
            <?php if ($agree) { ?>
            ...
            <?php } ?>
            <button type="submit" class="button continue submit_1"><?php echo $button_submit; ?></button>
        </div>
        </div>
        <?php } else { ?>
        <div class="buttons clearfix">
