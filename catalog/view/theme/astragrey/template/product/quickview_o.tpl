...
<!-- <script src="catalog/view/theme/astragrey/js/jquery.flexslider.js" type="text/javascript"></script>-->



<script src="catalog/view/theme/astragrey/js/fancybox/jquery.fancybox.js" type="text/javascript"></script>
<link href="catalog/view/theme/astragrey/stylesheet/fancybox.css" rel="stylesheet"> 
