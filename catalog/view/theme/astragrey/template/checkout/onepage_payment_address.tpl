<form class="form-horizontal">
  ...
  <div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    ...
    <div class="form-group">
      <label class="col-sm-4 control-label" for="input-payment-address-2"><?php echo $entry_address_2; ?></label>
      <div class="col-sm-6">
  ...
  <div class="buttons clearfix">
    <div class="">
      <button type="button" id="button-payment-address" data-loading-text="<?php echo $text_loading; ?>" class="button btn continue"><span><?php echo $button_continue; ?></span></button>
    </div>
  </div>
</form>
