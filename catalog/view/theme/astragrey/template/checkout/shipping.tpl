    ...
    <div class="panel-body">
      ...
      <form class="form-horizontal">
        <div class="form-group required">
          <label class="col-sm-3 col-xs-4 control-label" for="input-country"><?php echo $entry_country; ?></label>
        ...
        <div class="form-group required">
          <label class="col-sm-3 col-xs-4 control-label" for="input-zone"><?php echo $entry_zone; ?></label>
          <div class="col-sm-9 col-xs-8">
        ...
        <div class="form-group required">
          <label class="col-sm-3 col-xs-4 control-label" for="input-postcode"><?php echo $entry_postcode; ?></label>
          <div class="col-sm-9 col-xs-8">
            <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="form-control" />
          </div>
        </div>
        <input type="button" value="<?php echo $button_quote; ?>" id="button-quote" data-loading-text="<?php echo $text_loading; ?>" class="button" />
      </form>
