          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right" style="white-space: nowrap;"><?php if ($product['reorder']) { ?>
                <a href="<?php echo $product['reorder']; ?>" data-toggle="tooltip" title="<?php echo $button_reorder; ?>" class=""><button class="button"><i class="fa fa-shopping-cart"></i></button></a>
                <?php } ?>
                <a href="<?php echo $product['return']; ?>" data-toggle="tooltip" title="<?php echo $button_return; ?>" class=""><button class="button btn"><i class="fa fa-reply"></i></button></a></td>
            </tr>
            <?php } ?>
