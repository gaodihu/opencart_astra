<form class="form-horizontal">
  ...
  <div class="buttons clearfix">
    <div class="">
      <button type="button" id="button-shipping-address" data-loading-text="<?php echo $text_loading; ?>" class="button btn continue"><span><?php echo $button_continue; ?></span></button>
    </div>
  </div>
</form>
