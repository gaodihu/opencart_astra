<form class="form-horizontal">
  ...
  <div class="buttons">
    <div class="">
      <button type="button" id="button-guest-shipping" data-loading-text="<?php echo $text_loading; ?>" class="button continue btn btn-primary"><span><?php echo $button_continue; ?></span></button>
    </div>
  </div>
</form>
