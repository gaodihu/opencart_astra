	...
	public function index($setting) {
		...
		if ($data['products']) {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/recommended.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/module/recommended.tpl', $data);
			} else {
				return $this->load->view('default/template/module/recommended.tpl', $data);
			}
		}
	}
}